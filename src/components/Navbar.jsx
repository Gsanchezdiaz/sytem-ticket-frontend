          ...
          <div className="relative flex h-16 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              <button
                ...
                <svg className={`${mobileMenu ? 'hidden' : 'block'} h-6 w-6`} fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="flex flex-shrink-0 items-center">
                <img className="h-8 w-auto" src="https://sigeco.smartplus.com.ec/images/logo-small.png" alt="Expertec" />
                <span className='uppercase font-medium px-3'>Expertec CRM</span>
              </div>
              ...
              <div className="relative ml-3">
                ...
                {onProfile && (
                  <div
                    ...
                    ${onProfile ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
                    role="menu"
